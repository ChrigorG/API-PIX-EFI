...
### Descrição:
  ...
  Obs.: O pagamento via QRCode só funciona utilizando o certificado de **Produção**, sendo assim, o de Homologação serve para relizar os teste do próprio desenvolvimento.
