...
### Descrição:
  Este é um projeto que faz o uso e o consumo da **API EFI Bank**, antiga GerenciaNet. Um projeto voltado para **estudos e práticas de programação** além do enrriquecimento de conhecimento sobre a API da EFI Bank.
...
![tela-pix-pagamento](https://github.com/ChrigorG/API-PIX-EFI/assets/99369312/3db99a00-de89-4cc5-9059-a5b895e13a4d)
